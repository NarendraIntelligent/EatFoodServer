...
import com.example.narendra.eatfoodserver.Model.Category;
import com.example.narendra.eatfoodserver.Model.Token;
import com.example.narendra.eatfoodserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    // uri to place new Category
    Uri saveUri;
    //Request defined as an instance variable
    ...
    private void showDialog() {
        ...
        edtName=add_menu_layout.findViewById(R.id.edtFoodId);
...
//                                  newCategory = new Category(edtName.getText().toString(), uri.toString());
    ...
    private void loadmenu() {
        ...
        //ViewHolder is mapping for firebase
...
//            ) {
//                @Override
//                //we have load from firebase to server
